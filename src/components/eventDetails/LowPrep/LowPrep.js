...
etc.</li>
              ...
              <div className="note">
                ...
                <div className="para1">
                      <li style={{listStyle:'none'}} className="listPoint">1. <a className='link' href="https://www.leadsquared.com/what-is-hospital-management-system/">https://www.leadsquared.com/what-is-hospital-management-system/</a></li>
                      ...
                      <li style={{listStyle:'none'}} className="listPoint">3. <a className='link' href="https://towardsdatascience.com/microservice-architecture-and-its-10-most-important-design-patterns-824952d7fa41"> https://towardsdatascience.com/microservice-architecture-and-its-10-most-important-design-patterns-824952d7fa41</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">4. <a className='link' href="https://aws.amazon.com/blogs/architecture/store-protect-optimize-your-healthcare-data-with-aws/"> https://aws.amazon.com/blogs/architecture/store-protect-optimize-your-healthcare-data-with-aws/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">5. <a className='link' href="https://cloud.google.com/storage/docs/encryption">https://cloud.google.com/storage/docs/encryption</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">6. <a className='link' href="https://aws.amazon.com/docker/">https://aws.amazon.com/docker/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">7. <a className='link' href="https://kubernetes.io/">https://kubernetes.io/</a></li>
                      ...
                      <li style={{listStyle:'none'}} className="listPoint">9. <a className='link' href="https://github.com/features/actions">https://github.com/features/actions</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">10. <a className='link' href="https://spinnaker.io/">https://spinnaker.io/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">11. <a className='link' href="https://www.datadoghq.com/">https://www.datadoghq.com/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">12. <a className='link' href="https://sentry.io/welcome/"> https://sentry.io/welcome/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">13. <a className='link' href="https://www.techopedia.com/definition/16626/error-handling">https://www.techopedia.com/definition/16626/error-handling</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">14. <a className='link' href="https://bigsea.co/ideas/coding-etiquette-6-obvious-overlooked-best-practices/">https://bigsea.co/ideas/coding-etiquette-6-obvious-overlooked-best-practices/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">15. <a className='link' href="https://techbeacon.com/app-dev-testing/top-5-software-architecture-patterns-how-make-right-choice">https://techbeacon.com/app-dev-testing/top-5-software-architecture-patterns-how-make-right-choice</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">16. <a className='link' href="https://www.ibm.com/cloud/learn/devsecops">https://www.ibm.com/cloud/learn/devsecops</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">17. <a className='link' href="https://engineering.linkedin.com/blog/2016/08/writing-maintainable-integration-tests">https://engineering.linkedin.com/blog/2016/08/writing-maintainable-integration-tests</a></li>
                      ...
                      <li style={{listStyle:'none'}} className="listPoint">19. <a className='link' href="https://www.fullstackpython.com/microservices.html">https://www.fullstackpython.com/microservices.html</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">20. <a className='link' href="http://highscalability.com/start-here/">http://highscalability.com/start-here/</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">21. <a className='link' href="https://github.com/mercari/mercari-microservices-example">https://github.com/mercari/mercari-microservices-example</a></li>
                      <li style={{listStyle:'none'}} className="listPoint">22. <a className='link' href="https://engineering.mercari.com/en/blog/tag/microservices/">https://engineering.mercari.com/en/blog/tag/microservices/</a></li>
                </div>
                <div className="subtitle">
