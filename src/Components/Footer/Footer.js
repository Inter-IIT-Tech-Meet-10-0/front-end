        ...
        <div className={Classes.container}>
             ...
             <div className={Classes.headingContact}>
                 ...
                 <ul className={Classes.list}>
                    <li className={Classes.listItem2}> <IoMail color= {'white'} /><span  className={Classes.text}>mail-id@domain.com</span> </li>
                    <li className={Classes.listItem2}><BsTelephoneFill color={'white'}/><span className={Classes.text}>+91 1234567890</span> </li>
                    <li className={Classes.listItem2}><MdLocationOn color={'white'}/><span className={Classes.text}> Location</span> </li>
